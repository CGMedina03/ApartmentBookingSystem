...
if (isset($_GET['userId'])) {
    ...
    // Query the database to fetch the title and addOn for the given userId
    $sql = "SELECT title FROM rented WHERE id = $userId";

    $result = mysqli_query($conn, $sql);

    if ($result && mysqli_num_rows($result) > 0) {
        // Fetch the title and addOn
        $row = mysqli_fetch_assoc($result);
        $title = $row['title'];
        // Now, search the rooms table for the corresponding price using the title
        $sql_price = "SELECT price, description FROM rooms WHERE title = '$title'";
        $result_price = mysqli_query($conn, $sql_price);

        if ($result_price && mysqli_num_rows($result_price) > 0) {
            $row_price = mysqli_fetch_assoc($result_price);
            $price = $row_price['price'];
            $description = $row_price['description'];
        } else {
            // Handle the case where title is not found in rooms table or query fails
            echo "Error retrieving price from the database: " . mysqli_error($conn);
        }
    }
}
    ...
    <main class="page payment-page">
        <section class="payment-form dark">
            <div class="block-heading">
                <h2>Payment</h2>
                <p>The payment process involves securely transferring funds after completing the necessary
                    transactions.</p>
            </div>
            <form action="" method="post" onsubmit="return validateForm()">
                <div class="container">
                    ...
                    <div class="products">
                        ...
                        <div class="item">
                            ...
                            <p class="item-description">
                                <?php echo implode(" ", array_slice(explode(" ", $description), 0, 3)) . '...'; ?>
                            </p>
                        </div>
                    ...
                    <div class="gcash">
                        ...
                        <a href="ePayment/gcash.php?userId=<?php echo $userId; ?>">
                            <svg width="100px" height="80px" viewBox="0 0 2000 400" version="1.1"
                    ...
                    <form>
                        <div class="card-details">
                            <h3 class="title">Credit/Debit Card Details:<strong>
                                    <span id="cardtype-display"></span>
                                </strong>
                                <hr>
                                <div class="row">
                                    <!-- card name -->
                                    <div class="form-group col-sm-7">
                                        ...
                                        <input id="cname" type="text" class="form-control" name="cardname"
                                            placeholder="John More Doe" aria-label="Card Holder"
                                    ...
                                    <div class="form-group col-sm-5">
                                        ...
                                        <div class="input-group expiration-date">
                                            <input type="text" class="form-control" placeholder="MM" id="expmonth"
                                                name="expmonth" aria-label="MM" aria-describedby="basic-addon1">
                                            <span class="date-separator">/</span>
                                            <input type="text" class="form-control" placeholder="YY" id="expyear"
                                                name="expyear" aria-label="YY" aria-describedby="basic-addon1">
                                        </div>
                                    ...
                                    <div class="form-group col-sm-8">
                                        ...
                                        <input id="ccnum" type="text" class="form-control" name="cardnumber"
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input id="cvv" type="text" class="form-control" name="cvv" placeholder="352"
                                            required aria-label="CVV" aria-describedby="basic-addon1">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <small class="text-muted">For the password not enabled, leave the space
                                            blank</small>
                                    </div>
