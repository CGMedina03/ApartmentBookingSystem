            ...
            <div class="col-md-4">
                ...
                <div class="input-group has-validation">
                    <input type="text" class="form-control <?php echo isset($errors['email']) ? 'is-invalid' : ''; ?>"
                        ...
                        aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback" name="email"
                ...
                foreach ($filteredAddsons as $addson):
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="addons[]"
                            id="addon-<?php echo $addson['id']; ?>" value="<?php echo $addson['title']; ?>">
            ...
            <div class="col-12">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="invalidCheck3">
                        <a href="#" data-bs-toggle="modal" class="text-reset text-white text-decoration-none"
                            data-bs-target="#termsModal">Agree to terms and
                            conditions</a>
                    </label>
